        ...
        <div style={{ backgroundColor: "#000" }}>
            ...
            <div className={styles.container}>
                <div className={styles.conteudo2}>
                    ...
                    <p>
                        Neste documento você vai definir tudo que pode ou não ser feito dentro da sua empresa,
                        desde tolerância para atraso, pré requisitos básicos para contratação, tempo do contrato
                        de experiência, boas práticas e proibições; Sem esquecer das punições aplicadas aos transgressores.
                        Agora use esse modelo para fazer suas próprias edições e implantar em sua empresa.
                    </p>
                </div>
            </div>
            ...
            <div className={styles.cards2}>
                ...
                <div className={styles.containercard}>
                    ...
                    <div className={styles.cardContent}>
                        <p>
                            Antes do regimento interno não havia uma ordem e um controle dentro da minha empresa,
                            depois de implementar ele, hoje temos boas práticas e condutas apropriadas pelas vendedoras
                            e demais colaboradores das nossas lojas.
                        </p>
                    </div>
                </div>
            </div>
